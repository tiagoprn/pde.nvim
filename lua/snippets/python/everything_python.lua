...
local snippet = {
  python = {
    new_snippet("env_python", t([=[
	#!/usr/bin/env python
]=])),

        new_snippet("env_python3", t([=[
	#!/usr/bin/env python3
]=])),

        new_snippet("env_python_uv", t([=[
	#!/usr/bin/env -S uv run --script
]=])),

        new_snippet("bootstrap_with_logging", t([=[
	#!/usr/bin/env python3
	...
	if __name__ == "__main__":
        ...
        new_snippet("ordered_dict", fmt([=[
	${1:dict_name} = OrderedDict[
		('${2:key}', '${3:value}'),
	]
]=], { i(1, "dict_name"), i(2, "key"), i(3, "value") })),

        new_snippet("exception", fmt([=[
	try:
		${1:code}
	except:
		logging.exception(${2:message})
]=], { i(1, "code"), i(2, "message") })),

        new_snippet("exception_print_traceback", t([=[
	try:
		${1}
	...
	class ${1:ClassName}(${2:object}):
		...
		def __init__(self, ${4:arg}):
			...
			self.${4} = ${4}
			${6}
]=], { i(1, "ClassName"), i(2, "object"), i(3, "docstring for ${1"), i(4, "arg"), i(5, "super(${1") })),

        new_snippet("pathlib_current_path", t([=[
	from pathlib import Path
	current_path = str(Path().absolute())
	print(f'current_path:{current_path}')
]=])),

        new_snippet("pathlib_rootpath", t([=[
	from pathlib import Path
	...
	f'${1:string}'
        ...
        new_snippet("timestamp_iso", t([=[
	from datetime import datetime
	print(datetime.now().isoformat())
]=])),

        new_snippet("datestr", t([=[
	from datetime import datetime
	date_str = datetime.now().strftime('%Y-%m-%d %H:%M:%S.%f')
]=])),

        new_snippet("dateobj", t([=[
	from datetime import datetime
	date_obj = datetime.strptime('2011-12-31 11:59:59', '%Y-%m-%d %H:%M:%S')
]=])),

        new_snippet("today_and_date_objects", t([=[
	from datetime import datetime
	...
	ic('world')
        ...
        new_snippet("pprint_to_console", fmt([=[
	print('\n'); __import__('pprint').pprint(${1:var_name}, width=2); print('\n');  # noqa: E702, E703
]=], { i(1, "var_name") })),

        new_snippet("pprint_to_str", t([=[
	...
	def generate_random_number(start: int, finish: int, seed_bytes:int=128) -> str:
        ...
        new_snippet("stdout_write", t([=[
	sys.stdout.write('${1}')
]=])),

        new_snippet("function_type_hint_example", t([=[
	...
	#                         |> arguments
        ...
        new_snippet("immutable_sort_randomization", t([=[
	import random
	...
	shuffled_list = random.sample(sorted_list, k=len(sorted_list))  # you will create a new list, not changing test_list values
        ...
        new_snippet("mutable_sort_randomization", t([=[
	import random
	test_list = [12, 34, 234, 452, -1]
	...
	print(test_list)
        ...
        new_snippet("set-union", fmt([=[
	${1:set1} | ${2:set2}
]=], { i(1, "set1"), i(2, "set2") })),

        new_snippet("set-intersection", fmt([=[
	${1:set1} & ${2:set2}
]=], { i(1, "set1"), i(2, "set2") })),

        new_snippet("set-difference", fmt([=[
	${1:set1} - ${2:set2}
]=], { i(1, "set1"), i(2, "set2") })),
	...
	super().__init__()
        ...
        new_snippet("pytest_parametrize", t([=[
    ...
    def test_name(var1, var2):
        ...
        new_snippet("pytest_run_on_condition", fmt([=[
	@pytest.mark.skipif(${1:bool_condition}, reason="${2:string_describing_condition}")
]=], { i(1, "bool_condition"), i(2, "string_describing_condition") })),

        new_snippet("pytest_raises", t([=[
        ...
        new_snippet("pytest_skip_decorator", t([=[
	@pytest.mark.skip(reason="${1}")
]=])),

        new_snippet("function_info", t([=[
	...
	hashlib.md5("YOUR-STRING-GOES-HERE".encode('utf-8')).hexdigest()
        ...
        new_snippet("traceback_print_current_stack", t([=[
	__import__('traceback').print_stack()
]=])),

        new_snippet("pathlib_get_files_in_directory", t([=[
	from pathlib import Path
	...
	def get_files(path='.', filetype = ".py"):
        ...
        new_snippet("loop_on_list_popping_elements", t([=[
	while my_list:
	...
	print(message)
        ...
        new_snippet("stdlib_http_post_request", t([=[
  	...
  	conn.getresponse()
        ...
        new_snippet("sort_list_items_alphabetically", t([=[
	...
	sorted(lst, key=str.lower, reverse=True)
        ...
        new_snippet("json_dict_to_file", fmt([=[
