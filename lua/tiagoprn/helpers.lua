...
function M.run_flake8()
  ...
  local trigg_flake8_file = project_root .. "/" .. "trigg-flake8"
  local trigg_flake8_file_exists = M.get_file_exists(trigg_flake8_file)
  if trigg_flake8_file_exists == true then
...
function M.info_flake8()
  ...
  local trigg_flake8_file_exists = M.get_file_exists(trigg_flake8_file)
  if trigg_flake8_file_exists == true then
    vim.cmd('echomsg "trigg-flake8 file found on project root, so flake8 will be triggd for this file."')
  else
    vim.cmd('echomsg "trigg-flake8 file NOT found on project root, so flake8 will be disabled for this file."')
  end
end
